...
export function CTA() {
    ...
    return (
        <section ref={sectionRef} className="py-24 md:py-40 relative overflow-hidden bg-transparent">
            ...
            {/* Glow */}
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-[1000px] aspect-square bg-[radial-gradient(circle_at_center,var(--color-accent-gold-glow),transparent_70%)] pointer-events-none" />
            ...
            <div className="container mx-auto px-6 relative z-10 text-center">
                ...
                >
                    ...
                    <PremiumReveal type="fade" direction="top" delay={0.2}>
                        <div className="inline-flex items-center gap-2 px-6 py-2 rounded-full bg-[var(--color-accent-gold)]/5 text-[var(--color-accent-gold)] text-[10px] font-bold uppercase tracking-[0.2em] border border-[var(--color-accent-gold)]/10 mb-12">
                    ...
                    <PremiumReveal type="mask" direction="bottom" delay={0.3}>
                        <h2 className="font-headline text-[clamp(28px,6vw,72px)] font-semibold text-[var(--color-text-primary)] mb-10 leading-[1.05] tracking-tight uppercase">
                            Seu novo sorriso<br />
                            <span className="text-[var(--color-accent-gold)] font-headline italic font-light">começa hoje.</span>
                        </h2>
                    </PremiumReveal>
                    ...
                    <PremiumReveal type="fade" delay={0.5}>
                        <p className="text-[var(--color-text-secondary)] text-[18px] font-normal leading-[1.6] max-w-2xl mx-auto mb-16" style={{ fontFamily: 'var(--font-ui)' }}>
                            Agende uma avaliação detalhada e descubra como nosso protocolo <span className="text-[var(--color-accent-gold)] font-headline italic font-light">exclusivo</span> pode transformar sua autoestima.
                        </p>
                    </PremiumReveal>
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-8">
                        ...
                        <Magnetic strength={0.2} range={100}>
                            <button
                                ...
                                className="btn-premium bg-white/5 border-white/10 hover:border-[var(--color-accent-gold)]/50 w-full sm:w-auto !text-[var(--color-text-primary)]"
                            >
                                Falar com Concierge
                            </button>
                        </Magnetic>
