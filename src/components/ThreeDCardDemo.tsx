    ...
    return (
        <div className="flex justify-center py-10">
            <VisualContainer
                ...
                header={<h2 className="font-display text-xl font-[400] text-white uppercase tracking-wider">Protocolo de Elite</h2>}
            ...
            >
                <div key="1" className="flex flex-col items-center gap-6 text-center">
                    <div className="w-24 h-24 rounded-full bg-gradient-to-br from-[#F8F8F6] to-[#E6D3A3] flex items-center justify-center shadow-2xl">
                        <span className="text-black font-display text-3xl font-[400]">3D</span>
                    </div>
