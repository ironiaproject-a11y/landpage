            ...
            <div className="container mx-auto px-6 relative z-10">
                <div className="flex flex-col lg:flex-row gap-16 lg:gap-24 items-center">
                    ...
                    <div className="lg:w-1/2">
                        ...
                        <h2 className="font-display text-[clamp(28px,8vw,6.5rem)] font-medium text-white leading-[0.95] mb-12 md:mb-16 tracking-tight uppercase">
                            <PremiumReveal type="mask" direction="bottom" delay={0.2}>
                                <span>O Protocolo de</span>
                            </PremiumReveal>
                            <PremiumReveal type="mask" direction="bottom" delay={0.3}>
                                <span className="text-gradient-silver italic font-light block mt-2">Transformação.</span>
                            </PremiumReveal>
                        </h2>
                                ...
                                <m.div key={index} className="experience-step-item flex gap-6 md:gap-8 group relative z-10">
                                    <div className="flex flex-col items-center pt-1">
                                        <Magnetic strength={0.3} range={60}>
                                            <div className="w-12 h-12 rounded-full border border-white/10 flex items-center justify-center group-hover:border-[var(--color-silver-bh)]/30 transition-all duration-500 bg-[#0A0A0A] backdrop-blur-sm shadow-premium-1">
                                                <span className="text-[var(--color-silver-bh)]/60 group-hover:text-[var(--color-silver-bh)] font-display text-sm font-bold tracking-widest">{step.number}</span>
                                            </div>
                                        </Magnetic>
                                    </div>
                                    <div className="pb-8">
                                        <h3 className="text-xl md:text-2xl font-display font-medium text-white group-hover:text-[var(--color-silver-bh)] transition-colors mb-2 md:mb-3">{step.title}</h3>
                                ...
                                <div ref={visualRef} className="aspect-[4/5] relative overflow-hidden rounded-2xl">
                                    ...
                                    <div className="absolute bottom-12 left-12 right-12 z-20 experience-image-content">
                                        <div className="experience-content-parallax">
                                            ...
                                            <p className="text-white/70 text-sm font-light tracking-wide max-w-xs leading-relaxed">Planejamento personalizado e alta tecnologia para cada sorriso de elite.</p>
                                        </div>
                                    </div>
                                </div>
                            </VisualContainer>
                ...
                <div ref={ctaRef} className="mt-16 md:mt-32 flex justify-center">
                    <div className="inline-flex flex-col md:flex-row items-center gap-6 px-10 py-8 rounded-3xl border border-white/5 bg-white/2 hover:border-[var(--color-silver-bh)]/30 transition-all group cursor-pointer backdrop-blur-sm">
